...
namespace Cistern.Linq.Links
{
        ...
        , Optimizations.ILinkFastCount
    {
        ...
        public virtual IConsumable<V> MergeSelect<V>(IConsumable<U> consumable, Func<U, V> selector) =>
            consumable.ReplaceTailLink(new Select<T, U, V>(Selector, selector));

        IConsumable<U> Optimizations.IMergeWhere<U>.MergeWhere(IConsumable<U> consumable, Func<U, bool> predicate) =>
    ...
    sealed class Select<T, U, V> : Select<T, V>
    {
        ...
        public override IConsumable<W> MergeSelect<W>(IConsumable<V> consumer, Func<V, W> v2w) =>
    ...
    sealed class Select<T, U, V, W> : Select<T, W>
    {
        ...
        public override IConsumable<X> MergeSelect<X>(IConsumable<W> consumer, Func<W, X> w2x) =>
