...
namespace Cistern.Linq.Links
{
        ...
        , Optimizations.ILinkFastCount
    {
        ...
        public virtual IConsumable<V> MergeSelect<V>(Consumable<U> consumable, Func<U, V> selector) =>
            consumable.ReplaceTailLink(new Select<T, U, V>(Selector, selector));

        IConsumable<U> Optimizations.IMergeWhere<U>.MergeWhere(Consumable<U> consumable, Func<U, bool> predicate) =>
    ...
    sealed class Select<T, U, V> : Select<T, V>
    {
        ...
        public override IConsumable<W> MergeSelect<W>(Consumable<V> consumer, Func<V, W> v2w) =>
    ...
    sealed class Select<T, U, V, W> : Select<T, W>
    {
        ...
        public override IConsumable<X> MergeSelect<X>(Consumable<W> consumer, Func<W, X> w2x) =>
