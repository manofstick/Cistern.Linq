...
namespace Cistern.Linq.Links
{
        ...
        , Optimizations.IMergeWhere<T>
    {
        ...
        IConsumable<U> Optimizations.IMergeSelect<T>.MergeSelect<U>(Consumable<T> consumable, Func<T, U> selector) =>
            consumable.ReplaceTailLink(new WhereSelect<T, U>(Predicate, selector));

        public virtual IConsumable<T> MergeWhere(Consumable<T> consumable, Func<T, bool> second) =>
    ...
    sealed class Where2<T> : Where<T>
    {
        ...
        public override IConsumable<T> MergeWhere(Consumable<T> consumable, Func<T, bool> third) =>
    ...
    sealed class Where3<T> : Where<T>
    {
        ...
        public override IConsumable<T> MergeWhere(Consumable<T> consumable, Func<T, bool> forth) =>
