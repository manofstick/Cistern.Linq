...
namespace Cistern.Linq.Tests
{
    public class ConsistencyTests
    {
        ...
        {
            MethodInfo enumerableNotInQueryable = GetMissingExtensionMethod(typeof(Enumerable), typeof(System.Linq.Queryable), GetExcludedMethods());
        ...
        private class MethodComparer : IEqualityComparer<MethodInfo>
        {
            ...
            private Type Strip(Type t)
            {
                if (t.GetTypeInfo().IsGenericType)
                {
                    ...
                    if (g == typeof(System.Linq.IQueryable<>) || g == typeof(IEnumerable<>))
                    {
                ...
                {
                    if (t == typeof(System.Linq.IQueryable))
                    {
                        return typeof(IEnumerable);
                    }
                }
