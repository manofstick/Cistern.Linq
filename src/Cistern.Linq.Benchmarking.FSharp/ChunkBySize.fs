...
|-------- |-------------- |---------- |------------:|------------:|------------:|------:|--------:|--------:|------:|------:|----------:|
|     Seq |             0 |         1 |    131.0 ns |   0.7867 ns |   0.7359 ns |  1.00 |    0.00 |  0.0889 |     - |     - |     280 B |
| Cistern |             0 |         1 |    225.8 ns |   1.3106 ns |   1.2260 ns |  1.72 |    0.01 |  0.0837 |     - |     - |     264 B |
|         |               |           |             |             |             |       |         |         |       |       |           |
|     Seq |             0 |         5 |    131.0 ns |   0.9522 ns |   0.8907 ns |  1.00 |    0.00 |  0.0889 |     - |     - |     280 B |
| Cistern |             0 |         5 |    225.2 ns |   1.4336 ns |   1.2708 ns |  1.72 |    0.02 |  0.0939 |     - |     - |     296 B |
|         |               |           |             |             |             |       |         |         |       |       |           |
|     Seq |             0 |        10 |    131.1 ns |   1.2110 ns |   1.1327 ns |  1.00 |    0.00 |  0.0889 |     - |     - |     280 B |
| Cistern |             0 |        10 |    230.0 ns |   1.8958 ns |   1.7733 ns |  1.75 |    0.02 |  0.1066 |     - |     - |     336 B |
|         |               |           |             |             |             |       |         |         |       |       |           |
|     Seq |             1 |         1 |    180.1 ns |   1.2923 ns |   1.2088 ns |  1.00 |    0.00 |  0.1168 |     - |     - |     368 B |
| Cistern |             1 |         1 |    246.8 ns |   1.4025 ns |   1.3119 ns |  1.37 |    0.01 |  0.1040 |     - |     - |     328 B |
|         |               |           |             |             |             |       |         |         |       |       |           |
|     Seq |             1 |         5 |    192.2 ns |   1.2129 ns |   1.1345 ns |  1.00 |    0.00 |  0.1371 |     - |     - |     432 B |
| Cistern |             1 |         5 |    259.3 ns |   1.5756 ns |   1.3968 ns |  1.35 |    0.01 |  0.1140 |     - |     - |     360 B |
|         |               |           |             |             |             |       |         |         |       |       |           |
|     Seq |             1 |        10 |    195.3 ns |   1.3540 ns |   1.2665 ns |  1.00 |    0.00 |  0.1500 |     - |     - |     472 B |
| Cistern |             1 |        10 |    264.7 ns |   1.3085 ns |   1.0216 ns |  1.36 |    0.01 |  0.1268 |     - |     - |     400 B |
|         |               |           |             |             |             |       |         |         |       |       |           |
|     Seq |            10 |         1 |    566.7 ns |   4.4886 ns |   4.1986 ns |  1.00 |    0.00 |  0.2766 |     - |     - |     872 B |
| Cistern |            10 |         1 |    438.8 ns |   2.5716 ns |   2.4054 ns |  0.77 |    0.01 |  0.1955 |     - |     - |     616 B |
|         |               |           |             |             |             |       |         |         |       |       |           |
|     Seq |            10 |         5 |    290.0 ns |   2.2235 ns |   2.0799 ns |  1.00 |    0.00 |  0.1550 |     - |     - |     488 B |
| Cistern |            10 |         5 |    326.2 ns |   2.4963 ns |   2.3351 ns |  1.12 |    0.01 |  0.1445 |     - |     - |     456 B |
|         |               |           |             |             |             |       |         |         |       |       |           |
|     Seq |            10 |        10 |    251.3 ns |   2.1073 ns |   1.9711 ns |  1.00 |    0.00 |  0.1397 |     - |     - |     440 B |
| Cistern |            10 |        10 |    320.6 ns |   2.0478 ns |   1.9155 ns |  1.28 |    0.01 |  0.1497 |     - |     - |     472 B |
|         |               |           |             |             |             |       |         |         |       |       |           |
|     Seq |          1000 |         1 | 40,420.6 ns | 215.5599 ns | 191.0883 ns |  1.00 |    0.00 | 17.8833 |     - |     - |   56312 B |
| Cistern |          1000 |         1 | 19,200.7 ns | 120.9203 ns | 107.1927 ns |  0.48 |    0.00 | 10.2539 |     - |     - |   32296 B |
|         |               |           |             |             |             |       |         |         |       |       |           |
|     Seq |          1000 |         5 | 14,356.4 ns | 101.5684 ns |  95.0071 ns |  1.00 |    0.00 |  5.6915 |     - |     - |   17912 B |
| Cistern |          1000 |         5 |  9,581.8 ns |  69.1200 ns |  64.6549 ns |  0.67 |    0.01 |  4.1656 |     - |     - |   13128 B |
|         |               |           |             |             |             |       |         |         |       |       |           |
|     Seq |          1000 |        10 | 11,138.3 ns |  58.5439 ns |  54.7620 ns |  1.00 |    0.00 |  4.1656 |     - |     - |   13112 B |
| Cistern |          1000 |        10 |  9,709.5 ns |  72.4446 ns |  67.7647 ns |  0.87 |    0.01 |  3.4180 |     - |     - |   10768 B |
*)
